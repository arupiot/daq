...
|skip|connection.port_duplex|Other|Other|No local IP, check ext_loip in system.conf|
|skip|connection.port_link|Other|Other|No local IP, check ext_loip in system.conf|
|skip|connection.port_speed|Other|Other|No local IP, check ext_loip in system.conf|
|fail|network.brute|Security|Required||
|skip|poe.negotiation|Other|Other|No local IP, check ext_loip in system.conf|
|skip|poe.power|Other|Other|No local IP, check ext_loip in system.conf|
|skip|poe.support|Other|Other|No local IP, check ext_loip in system.conf|
